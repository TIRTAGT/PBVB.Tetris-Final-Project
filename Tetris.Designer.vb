...
Partial Class Tetris
    ...
    Private Sub InitializeComponent()
        ...
        GameArea.Font = New Font("Segoe UI", 20.0F, FontStyle.Bold, GraphicsUnit.Point)
        GameArea.Location = New Point(40, 129)
        GameArea.Margin = New Padding(4)
        GameArea.Name = "GameArea"
        GameArea.Size = New Size(346, 616)
        GameArea.TabIndex = 0
        ' 
        ' StartTetrisAction
        ' 
        ...
        StartTetrisAction.Font = New Font("Segoe UI", 18.0F, FontStyle.Bold, GraphicsUnit.Point)
        StartTetrisAction.ForeColor = Color.Indigo
        StartTetrisAction.Location = New Point(40, 31)
        StartTetrisAction.Margin = New Padding(4, 0, 4, 0)
        StartTetrisAction.Name = "StartTetrisAction"
        StartTetrisAction.Size = New Size(652, 54)
        ...
        Panel1.Location = New Point(441, 129)
        ...
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(188, 4)
        Panel2.TabIndex = 2
        ' 
        ' ScoreValueLabel
        ' 
        ScoreValueLabel.BackColor = Color.Transparent
        ScoreValueLabel.Font = New Font("Segoe UI", 14.0F, FontStyle.Bold, GraphicsUnit.Point)
        ScoreValueLabel.ForeColor = Color.LightGray
        ScoreValueLabel.Location = New Point(38, 52)
        ScoreValueLabel.Margin = New Padding(4, 0, 4, 0)
        ScoreValueLabel.Name = "ScoreValueLabel"
        ScoreValueLabel.Size = New Size(188, 49)
        ...
        Panel3.Location = New Point(441, 350)
        Panel3.Margin = New Padding(4)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(250, 345)
        Panel3.TabIndex = 7
        ' 
        ' TargetText8Label
        ' 
        TargetText8Label.AutoSize = True
        TargetText8Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText8Label.Location = New Point(8, 312)
        TargetText8Label.Margin = New Padding(4, 0, 4, 0)
        TargetText8Label.Name = "TargetText8Label"
        TargetText8Label.Size = New Size(139, 30)
        ...
        TargetText7Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText7Label.Location = New Point(8, 269)
        TargetText7Label.Margin = New Padding(4, 0, 4, 0)
        TargetText7Label.Name = "TargetText7Label"
        TargetText7Label.Size = New Size(139, 30)
        ...
        TargetText6Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText6Label.Location = New Point(8, 225)
        TargetText6Label.Margin = New Padding(4, 0, 4, 0)
        TargetText6Label.Name = "TargetText6Label"
        TargetText6Label.Size = New Size(139, 30)
        ...
        TargetText5Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText5Label.Location = New Point(8, 181)
        TargetText5Label.Margin = New Padding(4, 0, 4, 0)
        TargetText5Label.Name = "TargetText5Label"
        TargetText5Label.Size = New Size(139, 30)
        ...
        TargetText4Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText4Label.Location = New Point(8, 138)
        TargetText4Label.Margin = New Padding(4, 0, 4, 0)
        TargetText4Label.Name = "TargetText4Label"
        TargetText4Label.Size = New Size(139, 30)
        ...
        TargetText3Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText3Label.Location = New Point(8, 94)
        TargetText3Label.Margin = New Padding(4, 0, 4, 0)
        TargetText3Label.Name = "TargetText3Label"
        TargetText3Label.Size = New Size(139, 30)
        ...
        TargetText2Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText2Label.Location = New Point(8, 50)
        TargetText2Label.Margin = New Padding(4, 0, 4, 0)
        TargetText2Label.Name = "TargetText2Label"
        TargetText2Label.Size = New Size(139, 30)
        ...
        TargetText1Label.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        TargetText1Label.Location = New Point(8, 6)
        TargetText1Label.Margin = New Padding(4, 0, 4, 0)
        TargetText1Label.Name = "TargetText1Label"
        TargetText1Label.Size = New Size(139, 30)
        ...
        BackButton.Font = New Font("Segoe UI", 11.0F, FontStyle.Bold, GraphicsUnit.Point)
        BackButton.ForeColor = Color.Indigo
        BackButton.Location = New Point(596, 767)
        BackButton.Margin = New Padding(4)
        BackButton.Name = "BackButton"
        BackButton.Size = New Size(96, 44)
        ...
        PausePanel.ForeColor = Color.Indigo
        PausePanel.Location = New Point(530, 765)
        PausePanel.Margin = New Padding(4)
        PausePanel.Name = "PausePanel"
        PausePanel.Size = New Size(44, 46)

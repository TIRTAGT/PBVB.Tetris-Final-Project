...
Partial Class Menu
	...
	Private Sub InitializeComponent()
		...
		' HowToPlayAction
		' 
		HowToPlayAction.BackColor = Color.LightGray
		HowToPlayAction.Cursor = Cursors.Hand
		HowToPlayAction.Font = New Font("Segoe UI", 16F, FontStyle.Bold, GraphicsUnit.Point)
		HowToPlayAction.ForeColor = Color.Indigo
		HowToPlayAction.Location = New Point(76, 306)
		HowToPlayAction.Name = "HowToPlayAction"
		HowToPlayAction.Size = New Size(215, 43)
		HowToPlayAction.TabIndex = 5
		HowToPlayAction.Text = "HOW TO PLAY"
		HowToPlayAction.TextAlign = ContentAlignment.MiddleCenter
		' 
		' ExitAction
		' 
    ...
    Friend WithEvents HowToPlayAction As Label
